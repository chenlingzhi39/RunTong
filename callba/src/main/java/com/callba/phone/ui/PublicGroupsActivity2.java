...
public class PublicGroupsActivity2 extends BaseActivity {
    ...
    private int currentSize = 0, preCurrentSize = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        groupInfoAdapter.setOnItemClickListener(new RecyclerArrayAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                startActivity(new Intent(PublicGroupsActivity2.this, GroupSimpleDetailActivity.class).
    ...
    private void InitiateSearch() {
        ...
        clearSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((InputMethodManager) PublicGroupsActivity2.this.getSystemService(Context.INPUT_METHOD_SERVICE)).toggleSoftInput(InputMethodManager.SHOW_FORCED, InputMethodManager.HIDE_IMPLICIT_ONLY);
            }
        });
    ...
    private void HandleSearch() {
        imageSearchBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.i("search", "back");
                InitiateSearch.handleToolBar(PublicGroupsActivity2.this, cardSearch, editTextSearch, 20);
            }
        });

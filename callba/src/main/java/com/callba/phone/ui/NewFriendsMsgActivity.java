...
public class NewFriendsMsgActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        localBroadcastManager.registerReceiver(broadcastReceiver1, new IntentFilter(Constant.ACTION_CONTACT_CHANAGED));
    ...
    protected void onDestroy() {
        ...
        if (broadcastReceiver1 != null)
            localBroadcastManager.unregisterReceiver(broadcastReceiver1);

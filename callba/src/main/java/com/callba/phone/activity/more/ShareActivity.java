...
public class ShareActivity extends BaseActivity implements OnClickListener,
	...
	private CornerListView lv_share;
	...
	String contenturl = "http://wap.callda.com/";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bn_back = (Button) findViewById(R.id.bn_share_back);
		bn_back.setOnClickListener(this);

		lv_share = (CornerListView) findViewById(R.id.more_list_share);
